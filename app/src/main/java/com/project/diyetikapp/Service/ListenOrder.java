...
public class ListenOrder extends Service implements ChildEventListener {
    ...
    private void showNotification(String key, Request request) {
        ...
        intent.putExtra("userPhone",request.getPhone());// we need pu user phone
        ...
        builder.setAutoCancel(true)
                ...
                .setTicker("Diyetik")
                .setContentInfo("Siparişiniz güncellendi.")
                .setContentText("Sipariş #"+key+"güncellendi. Durumu :"+ Common.convertCodeToStatus(request.getStatus()))
